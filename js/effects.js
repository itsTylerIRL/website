    ...
    function addScanlineInteraction() {
        ...
        function animateScanlineEffects() {
            if (document.body.classList.contains('animations-paused')) {
                // Scanline is disabled: clear any lingering border effects
                elements.forEach(el => el.classList.remove('scanline-hit', 'scanline-linger'));
            } else {
...
function animateScanlineJS(scanlineElement) {
    ...
    function updateScanline() {
        if (document.body.classList.contains('animations-paused')) {
            // Scanline disabled while animations are paused
